...
class _IndicatorState extends State<Indicator> {
  ...
  Widget _buildDot(int index) {
    ...
    double zoom = 1.0 + (Indicator._indicatorZoom - 1.0) * selectedness;

    return Container(
      width: Indicator._indicatorSpacing,
      child: Material(
        color: widget.color,
        type: MaterialType.circle,
        child: SizedBox(
          width: Indicator._indicatorSize * zoom,
          height: Indicator._indicatorSize * zoom,
        ),
      ),
    );
  }
