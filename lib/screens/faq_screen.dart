...
import 'package:flutter_finey/external_widgets/faq_bot/chat_message_list_item.dart';
import 'package:flutter_finey/model/chat_message.dart';
  ...
  Widget _buildSendButton() {
    return new Container(
      ...
      child: new IconButton(
          icon: new Icon(Icons.send, color: Color(0xFF162A49)),
          onPressed: () {
